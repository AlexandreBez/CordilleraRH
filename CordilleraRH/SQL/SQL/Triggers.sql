...
CREATE TRIGGER DADOS_UPPERCASE_OPORTUNIDADE
BEFORE INSERT ON OPORTUNIDADE
FOR EACH ROW
BEGIN
	SET NEW.CARGO = UPPER(NEW.CARGO);
	SET NEW.REQUISITOS = UPPER(NEW.REQUISITOS);
	SET NEW.OBSERVACAO = UPPER(NEW.OBSERVACAO);
END#

CREATE TRIGGER DADOS_UPPERCASE_OPORTUNIDADE_INTERNA
BEFORE INSERT ON OPORTUNIDADE_INTERNA
FOR EACH ROW
BEGIN
	SET NEW.CARGO = UPPER(NEW.CARGO);
	SET NEW.REQUISITOS = UPPER(NEW.REQUISITOS);
