...
@Entity
@Table(name = "FILHO_EMPREGADO_RH")
public class Filho_Empregado_RH {
    
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "ID_FILHO_EMPREGADO_RH")
    private Integer id_filhoEmpregadoRH;
    ...
    public Filho_Empregado_RH(){}

    public Filho_Empregado_RH(Integer id_filhoEmpregadoRH, @NotNull(message = "{campo.nome.vazio}") String nome,
        ...
        this.id_filhoEmpregadoRH = id_filhoEmpregadoRH;
        this.nome = nome;
        this.idade = idade;
