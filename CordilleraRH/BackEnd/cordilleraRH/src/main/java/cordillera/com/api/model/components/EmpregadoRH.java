...
@Entity
@Table(name = "EMPREGADO_RH")
public class EmpregadoRH {
    
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "ID_EMPREGADO_RH")
    private Integer id_empregado_RH;
    ...
    public EmpregadoRH(Integer id_empregado_RH, @NotNull(message = "{campo.nome.vazio}") String nome,
        ...
        this.id_empregado_RH = id_empregado_RH;
        this.nome = nome;
        this.cpf = cpf;
        this.sexo = sexo;
        this.idade = idade;
    ...
    /**
     * @return Integer return the id_empregado_RH
     */
    public Integer getId_empregado_RH() {
        return id_empregado_RH;
    }

    /**
     * @param id_empregado_RH the id_empregado_RH to set
     */
    public void setId_empregado_RH(Integer id_empregado_RH) {
        this.id_empregado_RH = id_empregado_RH;
    }
